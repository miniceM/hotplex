...
**📊 [Full 2026 Roadmap →](docs/roadmap-2026.md)** — March 2026 Sprint: Complete all core features in one month.
...
### In Progress (March 2026)
 [ ] **Event Hooks**: Plugin system for custom audit sinks, session telemetry, and real-time notifications.
 ...
 [ ] **Multi-Language SDKs**: Python and TypeScript SDKs alongside Go.
